...
- 10 sec video of Cardiac organoid heart beating taken. The video has 30 frames per second. Then 450 images are then taken to do segmentation on it inorder to find the heart rate (mean pixel intensity per image/frame). 
